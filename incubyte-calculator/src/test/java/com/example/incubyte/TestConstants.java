...
public class TestConstants {
    public static final String COMMA_SEPARATED_NUMBERS = "1,2";
    public static final String COMMA_SEPARATED_INVALID_NUMBERS = "1,";
    ...
    public static final String NUMBERS_WITH_MULTIPLE_DELIMITERS = "//[*][%]\n1*2%3";
    public static final String NUMBERS_WITH_MULTIPLE_DELIMITERS_OF_VARIABLE_LENGTHS = "//[**][%]\n1**2%3";
